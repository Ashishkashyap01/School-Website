            ...
            try {
                        ...
                        $user = $statement->fetch();
                            ...
                            elseif (!password_verify($password, $user['password'])) {
                                ...
                                /*|------TODO:OTP Login------Enable after verify-otp module is completed.-----------------------------|*/
...
if (
   ...
   elseif (
        !isset($_SESSION['login_otp_expiry']) ||
        !is_numeric($_SESSION['login_otp_expiry']) ||
        time() >= (int) $_SESSION['login_otp_expiry']
    ) {
    ...
    elseif (
        !hash_equals(
            (string) $_SESSION['login_otp'],
            (string) $otp
        )
    ) {
    $_SESSION['login_otp_attempts']++;
    $remainingAttempts = 3 - $_SESSION['login_otp_attempts'];
    $error = "Invalid OTP. Remaining Attempts: {$remainingAttempts}";
    }
    else {
...
<link
rel="icon" type="image/png" href="/srs/assets/images/logo.png">
<link rel="stylesheet" href="/srs/admin/assets/css/admin.css">
<link rel="stylesheet" href="/srs/admin/assets/css/login.css">
</head>
<body>
<div class="login-wrapper">
    <div class="login-card">
        <img src="/srs/assets/images/logo.png" alt="Logo" class="login-logo">
        <h2 id="loginTitle">
        ...
        <?php endif; ?>
            ...
            <div id="loginForm" class="<?= isset($_SESSION['pending_admin']) ? 'hide-card' : 'show-card'; ?>">
        ...
        <div id="otpForm" class="<?= isset($_SESSION['pending_admin']) ? 'show-card' : 'hide-card'; ?>">
                    <p>
                    ...
                    <div class="otp-timer">
                        ...
                        <span
                        id="otpTimer"
                        data-expiry="<?= $_SESSION['login_otp_expiry'] ?? '' ?>">
                        </span>
                    </div>
